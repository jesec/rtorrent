...
CommandSlotTest::test_basics() {
  ...
  //   CPPUNIT_ASSERT(rpc::command_base_call_any(&test_any, rpc::make_target(),
  ...
  //   CPPUNIT_ASSERT(rpc::command_base_call_any_list(&test_any,
  //   rpc::make_target(), (int64_t)3).as_value() == 3);
}

void
CommandSlotTest::test_type_validity() {
  //   CPPUNIT_ASSERT((rpc::command_base_is_type<rpc::any_function,
  //   &rpc::command_base_call_any>::value));
  //   CPPUNIT_ASSERT((rpc::command_base_is_type<rpc::any_string_function,
