...
CommandDynamicTest::test_get_set() {
  ...
  CPPUNIT_ASSERT(rpc::commands.call_command("test_get_set.1", torrent::Object())
                   .as_string() == "1");
  CPPUNIT_ASSERT(
...
CommandDynamicTest::test_old_style() {
  ...
  CPPUNIT_ASSERT(
    rpc::commands.call_command("test_old_style.1", torrent::Object())
      .as_value() == 1);
  ...
  CPPUNIT_ASSERT(
    rpc::commands.call_command("test_old_style.2", torrent::Object())
      .as_value() == 1);
  ...
  CPPUNIT_ASSERT(
    rpc::commands.call_command("test_old_style.3", torrent::Object())
      .as_string() == "test.2");
  ...
  CPPUNIT_ASSERT(
    rpc::commands.call_command("test_old_style.4", torrent::Object())
      .as_string() == "test.3");
}
