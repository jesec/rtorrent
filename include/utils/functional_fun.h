...
public:
  ...
  void set(base_type* base) {
    m_base = std::shared_ptr<base_type>(base);
  }
  base_type* release() {
...
public:
  ...
  mem_fn0_t(Object* object, Func func)
    : m_object(object)
    , m_func(func) {}
  virtual ~mem_fn0_t() {}
...
public:
  ...
  mem_fn1_t(Object* object, Func func)
    : m_object(object)
    , m_func(func) {}
  virtual ~mem_fn1_t() {}
...
public:
  ...
  mem_fn3_t(Object* object, Func func)
    : m_object(object)
    , m_func(func) {}
  virtual ~mem_fn3_t() {}

  virtual Result operator()(Arg1 arg1, Arg2 arg2, Arg3 arg3) {
...
public:
  ...
  mem_fn2_t(Object* object, Func func)
    : m_object(object)
    , m_func(func) {}
  virtual ~mem_fn2_t() {}
...
public:
  ...
  const_mem_fn0_t(const Object* object, Func func)
    : m_object(object)
    , m_func(func) {}
...
public:
  ...
  const_mem_fn1_t(const Object* object, Func func)
    : m_object(object)
    , m_func(func) {}
...
public:
  ...
  mem_fn0_b1_t(Object* object, Func func, const Arg1 arg1)
    : m_object(object)
    , m_func(func)
    , m_arg1(arg1) {}
...
public:
  ...
  mem_fn1_b1_t(Object* object, Func func, const Arg1 arg1)
    : m_object(object)
    , m_func(func)
    , m_arg1(arg1) {}
  virtual ~mem_fn1_b1_t() {}

  virtual Result operator()(const Arg2 arg2) {
    return (m_object->*m_func)(m_arg1, arg2);
  }
...
public:
  ...
  mem_fn1_b2_t(Object* object, Func func, const Arg2 arg2)
    : m_object(object)
    , m_func(func)
    , m_arg2(arg2) {}
  virtual ~mem_fn1_b2_t() {}

  virtual Result operator()(const Arg1 arg1) {
    return (m_object->*m_func)(arg1, m_arg2);
  }
...
public:
  ...
  ptr_fn0_b1_t(Func func, const Arg1 arg1)
    : m_func(func)
    , m_arg1(arg1) {}
...
public:
  ...
  ptr_fn1_b1_t(Func func, const Arg1 arg1)
    : m_func(func)
    , m_arg1(arg1) {}
  virtual ~ptr_fn1_b1_t() {}

  virtual Result operator()(Arg2 arg2) {
...
public:
  ...
  ptr_fn2_b1_t(Func func, const Arg1 arg1)
    : m_func(func)
    , m_arg1(arg1) {}
  virtual ~ptr_fn2_b1_t() {}

  virtual Result operator()(Arg2 arg2, Arg3 arg3) {
    return m_func(m_arg1, arg2, arg3);
  }
...
class ftor_fn1_t
  : public function_base1<typename Ftor::result_type,
                          typename Ftor::argument_type> {
public:
  typedef typename Ftor::result_type   result_type;
  typedef typename Ftor::argument_type argument_type;

  ftor_fn1_t(Ftor ftor)
    : m_ftor(ftor) {}
  virtual ~ftor_fn1_t() {}

  virtual result_type operator()(argument_type arg1) {
    return m_ftor(arg1);
  }
...
template<typename Ftor>
class ftor_fn2_t
  : public function_base2<typename Ftor::result_type,
                          typename Ftor::first_argument_type,
                          typename Ftor::second_argument_type> {
public:
  typedef typename Ftor::result_type          result_type;
  ...
  ftor_fn2_t(Ftor ftor)
    : m_ftor(ftor) {}
  virtual ~ftor_fn2_t() {}

  virtual result_type operator()(first_argument_type  arg1,
...
public:
  ...
  convert_fn0_t(typename src_type::base_type* object) {
    m_object.set(object);
  }
...
public:
  ...
  convert_fn1_t(typename src_type::base_type* object) {
    m_object.set(object);
  }
...
public:
  ...
  convert_fn2_t(typename src_type::base_type* object) {
    m_object.set(object);
  }
...
bind_mem_fn(Object* object,
            Result (Object::*func)(Arg1, Arg2),
            const Arg1 arg1) {
...
template<typename Ftor>
inline function_base2<typename Ftor::result_type,
                      typename Ftor::first_argument_type,
                      typename Ftor::second_argument_type>*
ftor_fn2(Ftor ftor) {
...
convert_fn(function_base0<SrcResult>* src) {
  if (equal_types_t<function_base0<Result>, function_base0<SrcResult>>::result)
    ...
    return reinterpret_cast<
      typename equal_types_t<function_base0<Result>,
                             function_base0<SrcResult>>::first_type*>(src);
  else
...
convert_fn(function_base1<SrcResult, SrcArg1>* src) {
  if (equal_types_t<function_base1<Result, Arg1>,
                    function_base1<SrcResult, SrcArg1>>::result)
    // The pointer cast never gets done if the types are different,
    // but needs to be here to pleasant the compiler.
    return reinterpret_cast<
      typename equal_types_t<function_base1<Result, Arg1>,
                             function_base1<SrcResult, SrcArg1>>::first_type*>(
      src);
  else
...
convert_fn(function_base2<SrcResult, SrcArg1, SrcArg2>* src) {
  if (equal_types_t<function_base2<Result, Arg1, Arg2>,
                    function_base2<SrcResult, SrcArg1, SrcArg2>>::result)
    // The pointer cast never gets done if the types are different,
    // but needs to be here to pleasant the compiler.
    return reinterpret_cast<typename equal_types_t<
      function_base2<Result, Arg1, Arg2>,
      function_base2<SrcResult, SrcArg1, SrcArg2>>::first_type*>(src);
  else
    return new convert_fn2_t<Result, Arg1, Arg2, SrcResult, SrcArg1, SrcArg2>(
      src);
}
